...
/*		for(i = ext;i< (vHeight-ext);i++)
		    {
		        for(j = ext; j< (vWidth-ext);j++)
		        {
		            ...
		            //gaussian filter
		    //        gaussian_filter(window,i,j);

		            //find gradient map magnitude and direction
		            gradient(window,i,j);
		        }
		    }*/
